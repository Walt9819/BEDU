...
setwd("D:/Documentos/BEDU/BEDU/mod2/sesion06/data")

url <- "https://raw.githubusercontent.com/beduExpert/Programacion-con-R-Santander/master/Sesion-06/Ejemplo-01/cbe.csv"
download.file(url, "cbe.csv")
...
url <- "https://raw.githubusercontent.com/beduExpert/Programacion-con-R-Santander/master/Sesion-06/Ejemplo-01/global.txt"
download.file(url, "global.txt")
...
x <- w <- rnorm(1000)
for(t in 2:1000) x[t] <- x[t-1] + w[t] # caminata aleatoria x_t = x_{t-1} + w_t
